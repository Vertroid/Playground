...
public class AliyunPlayerStrategy extends CommonPlayerStrategy {
    private long fetchCounter = 0;
    private boolean fetchComplete = false;
    private final String REGEX = "^(http|https)://.*aliyuncs\\.com.*$";
    private final int DEFAULT_WIDTH = 3840;
    private final int DEFAULT_HEIGHT = 2160;
    private final long METADATA_FETCH_LIMIT = 20;

    public AliyunPlayerStrategy(AbstractMediaPlayer wrapper, MediaPlayer player) {
