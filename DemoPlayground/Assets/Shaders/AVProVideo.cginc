...
#if defined(STEREO_TOP_BOTTOM) || defined(STEREO_BOTTOM_TOP) || defined(STEREO_LEFT_RIGHT) || defined(STEREO_RIGHT_LEFT) || defined(STEREO_HALF_LEFT) || defined(STEREO_HALF_RIGHT) || defined(STEREO_HALF_TOP) || defined(STEREO_HALF_BOTTOM)
FLOAT4 GetStereoScaleOffset(bool isLeftEye, bool isYFlipped)
{
	FLOAT2 scale = FLOAT2(1.0, 1.0);
	FLOAT2 offset = FLOAT2(0.0, 0.0);

	// Top-Bottom, Bottom-Top, Half-Top and Half-Bottom
#if defined(STEREO_TOP_BOTTOM) || defined(STEREO_BOTTOM_TOP) || defined(STEREO_HALF_TOP) || defined(STEREO_HALF_BOTTOM)
...
#elif defined(STEREO_BOTTOM_TOP)
	if (isLeftEye)
	{
		offset.y = 0.5;
	}
#elif defined(STEREO_HALF_TOP)
	offset.y = 0.5;
#elif defined(STEREO_HALF_BOTTOM)
	offset.y = 0.0;
#endif
	...
	// Left-Right, Right-Left, Half-Left and Half-Right
#elif defined(STEREO_LEFT_RIGHT) || defined(STEREO_RIGHT_LEFT) || defined(STEREO_HALF_LEFT) || defined(STEREO_HALF_RIGHT)
...
#elif defined(STEREO_RIGHT_LEFT)
	if (isLeftEye)
	{
		offset.x = 0.5;
	}
#elif defined(STEREO_HALF_LEFT)
	offset.x = 0.0;
#elif defined(STEREO_HALF_RIGHT)
	offset.x = 0.5;
#endif
